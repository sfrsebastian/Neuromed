...
class ItemsTableViewController: UITableViewController , UISearchBarDelegate , UISearchDisplayDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if(tableView == self.searchDisplayController?.searchResultsTableView){
            item = filteredItems[indexPath.row]["nombre"] as! String
        }
        else{
            item = items[indexPath.row]["nombre"] as! String
        }
...
//                   tableView.cellForRowAtIndexPath(indexPath)?.accessoryType = UITableViewCellAccessoryType.Checkmark
    ...
    func filterContentForSearchText(searchText : String , scope : String = "Title"){
        ...
        var stringMatch = (item["nombre"] as! String).rangeOfString(searchText)
